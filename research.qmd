...
**[The Economic Consequences of Lower Retail Trading Costs](papers/JMP_draft.pdf){.paper-title target="_blank"}**\
with [Ming-Jen Lin](https://economicsatntu.wixsite.com/ming-jen-lin){.coauthor target="_blank"}

::: {.abstract}
Abstract: This paper studies how lower trading costs affect retail investors and the market through increased speculation. We leverage a 2017 reform in Taiwan that reduced the transaction tax specifically for day trading. Using detailed account-level transaction data, we show that investor responses offset gains from tax savings and reduce portfolio returns for two reasons. First, the increase in trading is driven disproportionately by less sophisticated investors who tend to lose money on each trade. Second, and surprisingly, day traders' per-trade performance worsens, eroding the tax-cut benefit. Consistent with the view that transaction costs serve a disciplinary role, we trace this deterioration to less attentive decision-making. Despite individual-level losses, market quality improves: intraday liquidity increases and volatility decreases.  Overall, our findings highlight a policy-relevant trade-off: increased retail speculation from lower trading costs can benefit markets while harming individual investors.
:::
